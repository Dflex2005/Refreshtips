...
const keyPoints = [
{
    ...
    title:"Science",
    text:"Simple sugar are sweet, crystalline and soluble in water.",
},
{
    id:2,
    img:"./images/science-icon1.png",
    title:"Science",
    text:"Hydrocarbons consist of hydrogen and carbon.",
},
{
    id:3,
    img:"./images/science-icon1.png",
    title:"Science",
    text:"The induce current and EMF depends on the strength of the magnet used.",
},
{
    id:4,
    img:"./images/business.png",
    title:"Commercial",
    text:"Monarchy is a type of government by one individual. It may be a king, queen, or emperor.",
},
{
    id:5,
    img:"./images/business.png",
    title:"Commercial",
    text:"A service is an act or performance offered by one party to another.",
},
{
    id:6,
    img:"./images/business.png",
    title:"Commercial",
    text:"A mineral product is a product gotten from mineral or group of minerals.",
},
{
    id:7,
    img:"./images/art-icon.png",
    title:"Art",
    text:"Non-fiction is a story based on real facts and information.",
},
{
    id:8,
    img:"./images/art-icon.png",
    title:"Art",
    text:"Pressure group are group of people who aims to influence the government",
},
{
    id:9,
    img:"./images/art-icon.png",
    title:"Art",
    text:"Election is the process of electing a representative or candidate to represent the people in government.",
}
];
