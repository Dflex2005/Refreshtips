...
const keyPoints = [
{
    ...
    title:"Science",
    text:"The greater the number of turns in coil, the greater the induce current and E.M.F in the circuit",
},
{
    id:2,
    img:"./images/science-icon1.png",
    title:"Science",
    text:"Test for protein - Burret test, million's test, trioxonitrate(V)acid test",
},
{
    id:3,
    img:"./images/science-icon1.png",
    title:"Science",
    text:"Osmosis takes place only in liquid medium",
},
{
    id:4,
    img:"./images/business.png",
    title:"Commercial",
    text:"The fastest means to advertise a product is through the internet",
},
{
    id:5,
    img:"./images/business.png",
    title:"Commercial",
    text:"Source of capital include Loans, Overdraft, Internally generated revenue etc.",
},
{
    id:6,
    img:"./images/business.png",
...
},
{
    ...
    title:"Art",
    text:"Oligarchy is a form of government that put political power in the hands of a few people",
},
{
    id:8,
    img:"./images/art-icon.png",
    title:"Art",
    text:"Facism is a form of government contolled by a dictator.",
},
{
    id:9,
    img:"./images/art-icon.png",
    title:"Art",
    text:"Nazism is a form of government in which the state has total control of all activities of the people with their fundamental right denied. ",
}
];
